...
`pangu model-health` is read-only and never contacts Gemini. To make one optional,
context-free live health request using the configured fast model and timeout, run:
